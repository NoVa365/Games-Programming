...
def kitchen():
    while True:
        ...
        if kitchen1.lower in ("check worktops", "Look at worktops","worktops"):
...
def livingroom():
    while True:
        print("The living room seems as run down as the rest of the house you do notice a safe sitting in the"
              " corner of the room.")
        livingroom1 = input("You hear the door slam shut behind you and you see that someone has locked you in you"
                            " need to find a way out?!")
        if livingroom1.lower in ("look around", "investigate"):
            print("You look around in a panic and you see the a set of table and chairs and a a couch, upon"
                  " close inspection you see a cabinet in the corner of the room")
        if livingroom1.lower in ("look in cabinet", "cabinet"):
            print("You check the cabinets for something to get you out, there is a key inside one of the draws.")
            inventory.append("key")
            global key
            key = True
        if livingroom1.lower in "use key" and key is True:
            print("You try the key with the door and luckily it works with the door and you manage to get out"
                  " of the room.")
            break
        elif print("You do not have a way out yet."):
            return False
...
#Next chapter will focus on traversing a house and using found objects in order to get through it.
    ...
    if part7.lower() in ("living room", "livingroom", "lounge", "go to living room"):
        print("You head to the living room")
        dead = livingroom()
